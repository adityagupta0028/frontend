          ...
          <div id="title" className="page-title">
            <div className="section-container">
              ...
              <div className="breadcrumbs">
                <Link to="/">Home</Link><span className="delimiter"></span>Contact Us
              </div>
            </div>
          </div>
                          ...
                          <div className="col-md-4 sm-m-b-30">
                            <div className="info-item">
                              ...
                              <div className="item-content">
                                ...
                                <p>8:00am – 4:00pm Delhi, New Delhi</p>
                          ...
                          <div className="col-md-4">
                            <div className="info-item">
                              ...
                              <div className="item-content small-width">
                                For information on Returns and Refunds, please click <Link to="/return-policy">here.</Link>
                              </div>
                            </div>
                          </div>
                        </div>
                  ...
                  <div className="block block-contact-form">
                    <div className="block-widget-wrap">
                      ...
                      <div className="block-content">
                        <form action="#" method="" className="contact-form" noValidate>
